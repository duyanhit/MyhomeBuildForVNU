...
// create a component
export default class AppMonthPicker extends Component {
  static propTypes = {
  ...
  getSelectedBackgroundColor(month) {
    if (
      ...
      month.format(monthYearFormat) ===
        this.props.selectedDate.format(monthYearFormat)
    ) {
  ...
  getSelectedForeGround(month) {
    ...
    if (
      month.format(monthYearFormat) ===
      this.props.currentDate.format(monthYearFormat)
    ) {
